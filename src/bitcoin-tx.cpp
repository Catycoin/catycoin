...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " catycoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  catycoin-tx [options] <hex-tx> [commands]  Update hex-encoded catycoin transaction\n" +
            "or:     catycoin-tx [options] -create [commands]   Create hex-encoded catycoin transaction\n" +
            "\n";
