...
const char * const BITCOIN_CONF_FILENAME = "catycoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Catycoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Catycoin";
#else
    // Unix
    return pathRet / ".catycoin";
#endif
#endif
}
