# Support for Output Descriptors in Catycoin Core

Since Catycoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `cat1...` for mainnet or `tcat1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on Catycoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Catycoin Core wallets, a convenience function `combo` is
