Catycoin Core version *0.15.1* is now available from:

  <https://download.catycoin.space/catycoin-0.15.1/>
...
A number of changes to the way Catycoin Core deals with peer connections and invalid blocks
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 kitties per kB (0.00001 CATY). This is to prepare for dropping the minimum transaction fee to 0.1 kitties per kB (0.0001 CATY) in the next release.
