...
"""Verify that starting catycoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start catycoin with -h for help text")
        ...
        self.log.info("Start catycoin with -version for version information")
        ...
        self.log.info("Start catycoind with -fakearg to make sure it does not start")
