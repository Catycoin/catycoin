...
bech32_templates = [
  ...
  ('cat',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('cat',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('cat',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('tcat',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('tcat',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('tcat',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rcat',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rcat',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rcat', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('tcat',  17, 32, False, False, False),
  ('rcat',  3,  1, False, False, False),
  ('cat',   15, 41, False, False, False),
  ('tcat',  0, 16, False, False, False),
  ('rcat',  0, 32, True,  False, False),
  ('cat',   0, 16, True,  False, False),
  ('tcat',  0, 32, False, True,  False),
  ('rcat',  0, 20, False, False, True)
]
